...
const PLANS = [
  {
    ...
    accent: "#64748b",
    features: ["Hasta 500 contactos", "Dashboard principal", "Mapa básico", "1 usuario admin", "Soporte por email","Seguridad estándar"],
    cta: "Comenzar",
    highlight: false,
  },
  {
    name: "Professional",
    target: "Alcalde municipal o Concejal Limitado",
    price: "$7.200.000",
    period: "COP / mes",
    usd: "≈ USD 540",
    color: "from-blue-700 to-blue-900",
    accent: "#3b82f6",
    features: ["Hasta 15.000 contactos", "Todo Starter +", "Análisis de redes sociales IA", "5 usuarios", "Mapa avanzado", "Campañas WhatsApp", "Soporte prioritario","Ciberseguridad reforzada"],
    cta: "Más popular",
    highlight: true,
  },
  {
    name: "Campaign",
    target: "Gran Alcaldía / Gobernación",
    price: "$11.000.000",
    period: "COP / mes",
    usd: "≈ USD 2.814",
    color: "from-emerald-700 to-emerald-900",
    accent: "#10b981",
    features: ["Contactos ilimitados", "Todo Professional +", "Predicción IA de votos", "Usuarios ilimitados", "API personalizada", "Reportes avanzados", "Soporte 24/7","Capacitación en sitio","Acceso a nuevas funciones antes que nadie","Gestor de cuenta dedicado","Análisis de competencia","Analisis Con IA de opinión pública","Integración cde IA para detectar oportunidades y amenazas en redes sociales","Simulador de escenarios electorales con IA","Ciberseguridad reforzada con IA para proteger datos sensibles de la campaña"],
    cta: "Contáctanos",
    highlight: false,
  },
];
